...
<head>
    ...
    <script type="text/javascript">
        ...
        if('WebSocket' in window){
            //尝试与服务器建立连接;(ssmwebsocket)项目名称
            websocket = new WebSocket("ws://localhost:8080/ssmwebsocket/webSocketServer");
        } else if ('MozWebSocket' in window) {
            websocket = new MozWebSocket("ws://localhost:8080/ssmwebsocket/webSocketServer");
        } else {
        ...
        //连接成功建立的回调方法， 握手成功并建立连接后，socket.onopen被调用
